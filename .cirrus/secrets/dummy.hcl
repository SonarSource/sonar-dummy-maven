secret {
    no_prefix = true
    path      = "github/token/SonarSource-sonar-dummy-ro"
    key {
        name   = "token"
        format = "GITHUB_TOKEN"
    }
...
secret {
    no_prefix = true
    path      = "artifactory/token/SonarSource-sonar-dummy-private-reader"
    key {
        name   = "access_token"
...
secret {
    no_prefix = true
    path      = "artifactory/token/SonarSource-sonar-dummy-qa-deployer"
    key {
        name   = "access_token"
